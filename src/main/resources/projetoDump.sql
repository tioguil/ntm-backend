...
values ('analista.junior@empresa.com.br', '$10$OHFdwvDrQ88PrvMoY.QX/uo4ksJj3kcy8yiYFBzMjjtpv1auqz5dO', 'Analista', 'Júnior', '(11) 7070-7070', '(11) 97070-7070', '00000000010', '33333333-3', 'TESTE DO ANALISTA', 'analista', '00000-000', 'Rua Analista', 	'123', 'Perto da casa do Analista', 'São Paulo', 'SP', 1);
...
insert into usuario (email, senha, nome, sobrenome, telefone, celular, cpf_cnpj, rg, observacao, perfil_acesso, cep, endereco, numero_endereco, complemento, cidade, uf, cargo_id) 
values ('analista.junior2@empresa.com.br', '$10$OHFdwvDrQ88PrvMoY.QX/uo4ksJj3kcy8yiYFBzMjjtpv1auqz5dO', 'Analista2', 'Júnior2', '(11) 7070-7070', '(11) 97070-7070', '00017000010', '33333333-3', 'TESTE DO ANALISTA', 'analista', '00000-000', 'Rua Analista', 	'123', 'Perto da casa do Analista', 'São Paulo', 'SP', 1);
#Vinculando Habilidades
...
insert into usuario (email, senha, nome, sobrenome, telefone, celular, cpf_cnpj, rg, observacao, perfil_acesso, cep, endereco, numero_endereco, complemento, cidade, uf, cargo_id) 
values ('analista.senior@empresa.com.br', '$10$OHFdwvDrQ88PrvMoY.QX/uo4ksJj3kcy8yiYFBzMjjtpv1auqz5dO', 'Analista', 'Sênior', '(21) 8080-8080', '(21) 98080-8080', '00000000011', '44444444-4', 'TESTE DO ANALISTA', 'analista', '00000-000', 'Rua Analista', 	'123', 'Perto da casa do Analista', 'Rio de Janeiro', 'RJ', 2);
#Vinculando Habilidades
...
insert into usuario (email, senha, nome, sobrenome, telefone, celular, cpf_cnpj, rg, observacao, perfil_acesso, cep, endereco, numero_endereco, complemento, cidade, uf, cargo_id) 
values ('analista.senior2@empresa.com.br', '$10$OHFdwvDrQ88PrvMoY.QX/uo4ksJj3kcy8yiYFBzMjjtpv1auqz5dO', 'Analista2', 'Sênior2', '(21) 8080-8080', '(21) 98080-8080', '00000012011', '44444444-4', 'TESTE DO ANALISTA', 'analista', '00000-000', 'Rua Analista', 	'123', 'Perto da casa do Analista', 'Rio de Janeiro', 'RJ', 2);
#Vinculando Habilidades
...
insert into usuario (email, senha, nome, sobrenome, telefone, celular, cpf_cnpj, rg, observacao, perfil_acesso, cep, endereco, numero_endereco, complemento, cidade, uf, cargo_id) 
values ('analista.pleno@empresa.com.br', '$10$OHFdwvDrQ88PrvMoY.QX/uo4ksJj3kcy8yiYFBzMjjtpv1auqz5dO', 'Analista', 'Pleno', '(11) 9090-9090', '(11) 99090-9090', '00000000012', '55555555-5', 'TESTE DO ANALISTA', 'analista', '00000-000', 'Rua Analista', 	'123', 'Perto da casa do Analista', 'Minas Gerais', 'MG', 3);
#Vinculando Habilidades
...
insert into usuario (email, senha, nome, sobrenome, telefone, celular, cpf_cnpj, rg, observacao, perfil_acesso, cep, endereco, numero_endereco, complemento, cidade, uf, cargo_id) 
values ('analista.pleno2@empresa.com.br', '$10$OHFdwvDrQ88PrvMoY.QX/uo4ksJj3kcy8yiYFBzMjjtpv1auqz5dO', 'Analista2', 'Pleno2', '(11) 9090-9090', '(11) 99090-9090', '000000000147', '55555555-5', 'TESTE DO ANALISTA', 'analista', '00000-000', 'Rua Analista', 	'123', 'Perto da casa do Analista', 'Minas Gerais', 'MG', 3);
#Vinculando Habilidades
...
insert into usuario (email, senha, nome, sobrenome, telefone, celular, cpf_cnpj, rg, observacao, perfil_acesso, cep, endereco, numero_endereco, complemento, cidade, uf, cargo_id) 
values ('gerente@empresa.com.br', '$10$OHFdwvDrQ88PrvMoY.QX/uo4ksJj3kcy8yiYFBzMjjtpv1auqz5dO', 'Gerente', 'Projeto', '(11) 1010-1010', '(11) 91010-1010', '00000000013', '66666666-6', 'TESTE DO GERENTE', 'gestor', '00000-000', 'Rua Gestor', 	'123', 'Perto da casa do Gestor', 'São Paulo', 'SP', 4);

insert into usuario (email, senha, nome, sobrenome, telefone, celular, cpf_cnpj, rg, observacao, perfil_acesso, cep, endereco, numero_endereco, complemento, cidade, uf, cargo_id) 
values ('admin@empresa.com.br', '$10$OHFdwvDrQ88PrvMoY.QX/uo4ksJj3kcy8yiYFBzMjjtpv1auqz5dO', 'Admin', 'Projeto', '(11) 1010-1010', '(11) 91010-1010', '00000000013', '66666666-6', 'TESTE DO ADMIN', 'adm', '00000-000', 'Rua Gestor', 	'123', 'Perto da casa do Gestor', 'São Paulo', 'SP', 5);
